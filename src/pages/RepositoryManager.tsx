...
const RepositoryManager = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="flex flex-col gap-3">
            <Button
              ...
              className="self-start h-8 px-2 -ml-2 text-muted-foreground hover:text-foreground"
            >
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
              <div>
                <h1 className="text-2xl font-semibold text-foreground">{repo}</h1>
                <p className="text-sm text-muted-foreground mt-0.5">{owner}/{repo}</p>
              </div>
      ...
      {/* Floating Action Button (Mobile) - Larger and better positioned */}
      <Button
        className="md:hidden fixed bottom-20 right-6 h-16 w-16 rounded-full shadow-lg z-50 touch-manipulation active:scale-95 transition-transform bg-primary hover:bg-primary/90"
